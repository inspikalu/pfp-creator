...
const App: React.FC = () => {
  ...
  return (
    <div className="App bg-blue-500 min-h-screen flex flex-col items-center justify-center text-white">
      <h1 className="text-5xl font-bold mb-8 text-yellow-400 outline outline-4 outline-black">
        ZEUS PFP CREATOR
      </h1>
      <div className="flex items-center justify-center space-x-8 p-8 bg-white rounded-lg shadow-2xl">
      <div className="avatar-container w-[493px] aspect-square -skew-x-3 -skew-y-3 border-8 border-yellow-400 shadow-[0_0_10px_rgba(255,215,0,0.5)]">
